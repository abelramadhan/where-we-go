    ...
    <ol className='flex flex-col gap-6'>
      ...
      <Step title='Create some tables and insert some data'>
        <p>
          ...
          for your Supabase project to create a table and insert some example data. If youre stuck for creativity, you
      ...
      <Step title='Query Supabase data from Next.js'>
        <p>
          ...
          <span className='rounded-md bg-foreground/20 px-2 py-1 text-foreground/80'>/app/notes/page.tsx</span> and add
          the following.
        </p>
        <Code code={server} />
